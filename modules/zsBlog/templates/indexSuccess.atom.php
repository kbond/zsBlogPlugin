...
<feed xmlns="http://www.w3.org/2005/Atom">
  <title><?php echo sfConfig::get('app_zsBlogPlugin_title', 'My Blog') ?></title>
  <subtitle>Latest Articles</subtitle>
  <link href="<?php echo url_for('zs_blog', array('sf_format' => 'atom'), true) ?>" rel="self"/>
  <link href="<?php echo url_for('@zs_blog', true) ?>"/>
  ...
  <id><?php echo sha1(url_for('zs_blog', array('sf_format' => 'atom'), true)) ?></id>
